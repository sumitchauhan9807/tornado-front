      ...
      <div className="container-wide">
        ...
        <div className={`mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-${data.listsPerRow}`}>
          {data.descriptionLists.map((list, index) => {
            return (
              <div key={index} className="reveal pp-card flex flex-col rounded-2xl border border-border bg-surface p-6 is-visible" data-delay={0}>
                ...
                <h3 className="mt-4 font-display text-lg font-semibold tracking-[-0.01em] text-ink-strong">{list.heading}</h3>
