const ContactForm = (props) => {
  return (
    <section className="container py-10 md:py-14 lg:py-16">
      <div style={{backgroundColor:"#7A17F4"}} className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-accent to-[hsl(258_75%_38%)] p-8 md:p-14">
        ...
        <div className="relative grid gap-10 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <h2 className="mt-4 font-display text-[clamp(1.75rem,3.4vw,3rem)] font-medium leading-[1.05] tracking-[-0.02em] text-white text-balance">{props.heading}</h2>
            <p className="mt-4 max-w-xl text-[15px] leading-[1.65] text-white/85">{props.subText}</p>
          </div>
            ...
            <div className="space-y-3">
              <form className="space-y-2.5">
                <div className="grid gap-2.5 sm:grid-cols-2">
                  <div>
                    <input name="name" required maxLength={30} placeholder="Full name" aria-label="Full name" aria-invalid="false" className="w-full rounded-lg border border-white/25 bg-white/10 px-3.5 py-2.5 text-[14px] text-white placeholder:text-white/55 focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/20"  />
                  </div>
                  <div>
                      ...
                      <div className="PhoneInput">
                        <div className="PhoneInputCountry">
                          ...
                          <div aria-hidden="true" className="PhoneInputCountryIcon PhoneInputCountryIcon--border">
                            <img className="PhoneInputCountryIconImg" alt="United States" src="https://purecatamphetamine.github.io/country-flag-icons/3x2/US.svg" />
                          </div>
                          <div className="PhoneInputCountrySelectArrow" />
                        </div>
                        <input type="tel" autoComplete="tel" placeholder="Phone number" aria-label="Phone number" className="PhoneInputInput" defaultValue={+1} />
                      </div>
                    </div>
                  </div>
                  <button type="submit" disabled className="group inline-flex items-center justify-center gap-2 rounded-lg bg-white px-5 py-2.5 text-[14px] font-medium text-accent shadow-md transition-all hover:shadow-lg active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed" title="Verify your email first">
                    {props.buttonText}
